      ...
      <div class="w-full p-6 bg-gray-200 rounded-lg shadow-md">
        ...
        <div class="flex flex-col">
          <div class="flex items-center mb-4">
            <label
              for="key"
              class="w-16 block text-gray-700 text-md font-bold mb-2"
              >Key:
            </label>
            <input
              ref="keyInput"
          ...
          <div class="flex items-center mb-4">
            ...
            <div class="inline-block relative w-32">
              <select
                ...
                class="block appearance-none bg-blue-600 text-gray-200 w-full hover:border-gray-500 px-4 py-2 pr-8 rounded-r leading-normal focus:outline-none focus:shadow-outline"
              >
                <option v-for="type in formatTypes" :key="type" :value="type">{{
                  type
                }}</option>
        ...
        <div class="flex items-center justify-end">
          <BaseButton text="確認" class="mr-4 btn-blue" @click="update" />
          <BaseButton
            text="取消"
...
export default class PopupModel extends Vue {
  @Ref() readonly keyInput!: HTMLInputElement;
  @Ref() readonly valueInput!: HTMLInputElement;
  @Prop({ required: true }) resource!: ResourceItem;
